...
public class InsiemeFactory extends org.jooq.util.mysql.MySQLFactory {
	 ...
	 */
	public InsiemeFactory(java.sql.Connection connection) {
		super(connection);
	 ...
	 */
	@Deprecated
	public InsiemeFactory(java.sql.Connection connection, org.jooq.SchemaMapping mapping) {
	 ...
	 */
	public InsiemeFactory(java.sql.Connection connection, org.jooq.conf.Settings settings) {
	...
	private final void initDefaultSchema() {
		org.jooq.conf.SettingsTools.getRenderMapping(getSettings()).setDefaultSchema(com.insieme.common.database.dto.Insieme.INSIEME.getName());
	}
}
